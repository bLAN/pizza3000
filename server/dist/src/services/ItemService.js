...
let ItemService = class ItemService {
    ...
    get itemWithAvailabilityRepo() {
        return this.repoService.getRepository(ItemWithAvailability_1.ItemWithAvailability);
    }
    getItems() {
    ...
    canOrderItem(itemId) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.itemWithAvailabilityRepo.findOne({ id: itemId });
            if (!item)
                return false;
